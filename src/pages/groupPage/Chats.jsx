...
function Chat() {
  ...
  const handleJoinRequestAction = (requestId, action) => {
    fetch(`http://localhost:3000/api/chats/${contextId}/joinRequests/${requestId}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
      ...
      .catch((err) => console.error("Error handling join request:", err));
  };
  return (
